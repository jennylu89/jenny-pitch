export const niche = {
  ...
  summaryRows: [
    ...
    },
    {
      ...
      proof: "At MegPrime Pay I designed trust-critical communication that mainstream users understood, hiding USDC, KYC, and SEC disclosures behind plain-language flows. Messaging that people actually trust is the work I do.",
    },
    {
    ...
    },
    {
      ...
      proof: "I rebuilt Giant Eagle's navigation IA around customer tasks instead of the org chart (278% cake-ordering clicks), and built a 50+ component design system at Roadrunner.",
    },
    {
      ask: "Comfort generating copy and content using AI",
      proof: "I use Claude Code and Figma MCP daily to generate UI, copy, and production React components. Designing with AI in the loop is already how I work.",
    },
    {
    ...
    tiles: [
      {
        ...
        body: "I prototype in Claude Code to move 10x, then bring research and taste so speed never costs quality.",
      },
      {
        icon: "fa-light fa-arrows-spin",
        heading: "Research to shipped",
        body: "I run my own studies, synthesize the data, and ship the React. No handoff gaps.",
      },
      {
        icon: "fa-light fa-layer-group",
        heading: "Make the complex feel simple",
        body: "Regulated fintech, 4M-member loyalty, multi-audience IA: I make dense systems feel obvious.",
      },
      {
